      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Worker supervision', slug: 'runtime/cluster-services' },
            { label: 'Bundle integrity', slug: 'runtime/security-replay-and-trust' },
          ...
          items: [
            {
              ...
              items: [
                { label: 'Complete overview', slug: 'native/overview' },
                { label: 'Components & syntax', slug: 'native/components' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'PAM Native UI', slug: 'packages/mobile-ui' },
                { label: 'UI component catalog', slug: 'packages/mobile-ui-catalog' },
              ],
            },
            {
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Media & capture', slug: 'packages/native-media' },
                ...
                { label: 'Canvas 2D', slug: 'packages/native-canvas' },
                { label: 'Programmable GPU', slug: 'packages/native-gpu' },
                { label: 'Native 3D', slug: 'packages/native-3d' },
              ],
            },
            {
              label: 'Device & system',
            ...
            {
              label: 'Cloud, commerce & identity',
              items: [
                { label: 'Auth & secure storage', slug: 'packages/native-auth' },
                ...
                { label: 'Realtime WebSockets', slug: 'packages/native-realtime' },
                { label: 'Background Transfer', slug: 'packages/native-background-transfer' },
              ],
            },
            {
              label: 'Offline, quality & operations',
              items: [
                { label: 'Nitro data layer', slug: 'packages/native-nitro' },
                { label: 'Offline Sync', slug: 'packages/native-sync' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Runtime DevTools', slug: 'native/devtools' },
                { label: 'Build hygiene', slug: 'native/build-hygiene' },
                { label: 'iOS runtime & host', slug: 'native/ios-renderer' },
                { label: 'PHP API index', slug: 'native/php-api-index' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'pushinbr/pam-http-psr', slug: 'packages/psr' },
            { label: 'pushinbr/pam-http-testing', slug: 'packages/testing' },
