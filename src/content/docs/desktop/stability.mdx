...
PAM Desktop 1.1.1 defines a stable application contract for Linux x86-64.
...
The 1.1.1 local validation record also passes 10 protocol tests, 25 host tests,
the PHP API snapshot, Composer validation, and PHPStan with 35 analyzed files.
