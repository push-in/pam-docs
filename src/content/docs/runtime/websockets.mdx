...
PAM's WebSocket transport shares the native listener with HTTP. The optional `pushinbr/pam-socket` package adds event-oriented APIs, authentication, rooms, broadcasts, acknowledgements, adapters, and session resume support.
