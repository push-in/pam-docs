---
title: pushinbr/pam-psr-bridge
description: Run PSR-7 requests, PSR-15 middleware and handlers, and PSR-17 factories on PAM.
---

`pushinbr/pam-psr-bridge` provides PSR-7, PSR-15, and PSR-17 interoperability using the official PHP-FIG interfaces.
...
:::note[License]
`pushinbr/pam-psr-bridge` uses the Apache License 2.0.
:::
