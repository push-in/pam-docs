...
font glyphs. When its parent uses centered or trailing cross-axis alignment,
the platform renderer applies the same alignment inside that frame. This keeps
the visible glyphs aligned with adjacent icons while preserving safe text
measurement.
