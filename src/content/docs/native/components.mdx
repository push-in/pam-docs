...
| --- | --- | --- |
| Layout | `Screen`, `View`, `Column`, `Row`, `Grid`, `SafeAreaView`, `Spacer` | [Layout & views](./layout-and-views/) |
| Text and controls | `Text`, `Input`, `TextInput`, `Button`, `Pressable`, `Toggle`, `NativeSwitch` | [Text, input & controls](./text-input-controls/) |
| Images | `Image`, `ImageBackground`, `DrawingCanvas` | [Images & cache](./images-and-cache/) |
| Media | `MediaPlayer` for video and audio | [Video & audio](./video-and-audio/) |
| Scrolling | `Scroll`, `ScrollView`, `FlatList`, `VirtualizedList`, `SectionList`, `VirtualGrid`, `RefreshControl` | [Scroll & lists](./scroll-and-lists/) |
| Interaction | `GestureDetector`, `InteractionRegion`, `Animated`, touchable compatibility aliases | [Interaction & motion](./interaction-and-motion/) |
| Presentation | `Modal`, `BottomSheet`, `ActivityIndicator`, `StatusBar`, `KeyboardAvoidingView`, `DrawerLayoutAndroid`, `InputAccessoryView` | [Overlays & system UI](./overlays-and-system-ui/) |
| Web content | `WebView` | [WebView](./webview/) |
