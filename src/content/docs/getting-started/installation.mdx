...
PAM 2.2.4 ships prebuilt Linux and macOS releases for x86_64 and ARM64. Linux
...
See [release 2.2.4](../../project/release-2-2-4/) for the exact artifacts,
clean-project evidence, verification commands, and public package records.
