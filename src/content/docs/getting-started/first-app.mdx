...
Read [Choose a target](/getting-started/choose-a-target/) before committing to native mobile or desktop: their platform support differs from the server runtime.
