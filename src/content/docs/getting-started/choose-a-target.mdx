...
| Android application, low-level UI | `pam init my-app --template mobile` | Android API 26–36; no iOS |
...
Choose PAM Native when you want real native Android Views while keeping application state and composition in PHP. It is not a WebView and does not include React's JavaScript runtime.

:::note[iOS is a contribution opportunity]
PAM Native has no iOS host or UIKit/SwiftUI renderer today. Do not begin an iOS product assuming compatibility. If native protocol design, Swift, UIKit, or SwiftUI is your area, see [Contributing](../../community/contributing/).
:::
