...
PAM runs an unmodified Laravel application in a persistent PHP Embed worker. Integration classes live in the PAM binary under `Pam\Laravel`; your project depends on Laravel and its ordinary Composer packages.
